...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x49, 0x0a, 0x0a, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x12, 0x3b, 0x0a, 0x05, 0x47, 0x72, 0x65, 0x65,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.HelloWorld.Greet:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.HelloWorld.Greet:output_type -> helloworld.HelloReply
...
func (c *helloWorldClient) Greet(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (*UnimplementedHelloWorldServer) Greet(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _HelloWorld_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).Greet(ctx, req.(*HelloRequest))
	}
